...
@section('content')
    ...
    >
        ...
        <div class="form-group">
            <label for="book_name" class="col-form-label">Название книги:</label>
            @error('book_name')
        ...
        <div class="form-group">
            <label class="col-form-label" for="author_id">Авторы:</label>
            <div class="col-sm-6">
            ...
            <div class="col-sm-10">
                @isset($book->image)
                    <label class="btn btn-success btn-file">
                        Загрузить <input type="file" style="display: none" id="image" name="image"
                                         value="{{ $book->image }}">
                    </label>
